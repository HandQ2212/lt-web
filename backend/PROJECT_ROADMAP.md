...
- **[AU-001] Thiết lập Security Foundation**
...
- **[AU-002] Hệ thống Đăng ký & Đăng nhập**
...
- **[US-001] Quản lý thông tin cá nhân**
...
- **[NT-001] Dịch vụ Thông báo & Announcement**
...
- **[CR-001] Quản lý Khách hàng tiềm năng (Leads)**
...
- **[CR-002] Nhật ký Tư vấn (Consultations)**
...
- **[SM-001] Quản lý Chi nhánh & Khóa học**
...
- **[SM-002] Quản lý Phòng học (Rooms)**
...
- **[LM-001] Quản lý Lớp học (Classes)**
...
- **[LM-002] Đăng ký & Ghi danh (Enrollment)**
...
- **[LM-003] Quản lý Điểm danh (Attendance)**
...
- **[LM-004] Quản lý Bài tập (Assignments)**
...
- **[FN-001] Hệ thống Hóa đơn & Học phí**
...
- **[FN-002] Xử lý Giao dịch & Quản lý Nợ (Debt)**
...
- **[FN-003] Quản lý Chi phí Vận hành (Expenses)**
...
- **[FN-004] Tính toán Lương & Phụ cấp (Payroll Basic)**
...
- **[AN-001] Doanh thu & Lợi nhuận (P&L Reports)**
...
- **[AN-002] Phân tích Hiệu suất & Marketing**
