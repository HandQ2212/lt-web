  ...
  return (
    <Box
      sx={{
        ...
        bgcolor: '#FFFDF5',
        background:
          'radial-gradient(circle at 20% 18%, rgba(251,191,36,0.34), transparent 18rem), radial-gradient(circle at 82% 18%, rgba(244,114,182,0.18), transparent 18rem), linear-gradient(180deg, #FFFDF5 0%, #FFF7DF 100%)',
      }}
    >
